...
////<ExcelBuddyConfig>BuddyExcel = CAL_WSPXI_NF_B30RX_TCF_Rev1.0.xlsx;ExcelDisplay = 1<ExcelBuddyConfig/>
////<xTestLimitBuddyConfig>BuddyTestLimit = 2MM6-1720_NF_TSF_Rev2.csv<TestLimitBuddyConfig/>
////<xCorrelationBuddyConfig>BuddyCorrelaton = 2MM6-1720_NF-COR_Rev2.csv<CorrelationBuddyConfig/>
...
public class TestPlan : MarshalByRefObject, IATFTest
{
    ...
    public string DoATFInit(string args)
    {
        ...
        {
            MessageBox.Show("Error SP.AppendFormat");
        }
        #endregion
        try
        {
